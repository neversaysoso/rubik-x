...
(function($, document) {
	var domBuffer = '<div class="rbk-dtpicker" data-type="datetime">\
		<div class="rbk-dtpicker-header">\
			<button data-id="btn-cancel" class="rbk-btn">取消</button>\
			<button data-id="btn-ok" class="rbk-btn rbk-btn-blue">确定</button>\
		</div>\
		<div class="rbk-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>\
		<div class="rbk-dtpicker-body">\
			<div data-id="picker-y" class="rbk-listpicker">\
				<div class="rbk-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-m" class="rbk-listpicker">\
				<div class="rbk-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-d" class="rbk-listpicker">\
				<div class="rbk-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-h" class="rbk-listpicker">\
				<div class="rbk-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
			</div>\
			<div data-id="picker-i" class="rbk-listpicker">\
				<div class="rbk-listpicker-inner">\
					<ul>\
					</ul>\
				</div>\
